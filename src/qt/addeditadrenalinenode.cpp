    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 5000 ITZ TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter your transaction output index");
    ui->donationaddressLineEdit->setPlaceholderText("Enter aITZaddress for your MN donation");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:55675)");
        msg.exec();
        return;
    }
